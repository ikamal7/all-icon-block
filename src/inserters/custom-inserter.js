...
export default function CustomInserterModal( props ) {
	...
	return (
		<Modal
			...
			title={ __( 'Custom Icon', 'all-icon-block' ) }
		...
		>
			<div className="icon-custom-inserter">
				<div className="icon-custom-inserter__content">
					<TextareaControl
						label={ __( 'Custom icon', 'all-icon-block' ) }
				...
				<div className="icon-custom-inserter__sidebar">
					<div className="icon-preview">
						...
						<div className="icon-controls">
							<div className="icon-controls__size">
								<span>
									{ __( 'Preview size', 'all-icon-block' ) }
								</span>
								<RangeControl
									min={ 24 }
									max={ 400 }
					...
					<div className="icon-insert-buttons">
						<Button
							label={ __( 'Clear custom icon', 'all-icon-block' ) }
							isSecondary
							disabled={ ! customIcon }
							onClick={ () => setCustomIcon( '' ) }
						>
							{ __( 'Clear', 'all-icon-block' ) }
						</Button>
						<Button
							label={ __( 'Insert custom icon', 'all-icon-block' ) }
							isPrimary
							disabled={ ! isSVG || ! customIcon }
							onClick={ insertCustomIcon }
						>
							{ __( 'Insert custom icon', 'all-icon-block' ) }
						</Button>
					</div>
				</div>
			</div>
